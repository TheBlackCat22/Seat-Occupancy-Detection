...
# final_df = pd.read_csv('../web integration/seat_status.csv')
# final_df.sort_values(by=['Camera Number', 'Chair Number'], inplace=True)
# final_df.to_csv('../web integration/seat_status.csv', index=False)
# print(final_df)
# exit()

final_df = load_images_from_folder('data')
# print(final_df)
# print(final_df.describe())
# print(type(final_df['Camera Number']))
